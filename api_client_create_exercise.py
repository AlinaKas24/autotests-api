...
from models.courses_model import CreateCourseRequestModel
from models.exercise_model import CreateExerciseRequestModel
...
create_exercise_request = CreateExerciseRequestModel(
    title="Exercise 1",
